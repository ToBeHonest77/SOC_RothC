...
SOC_Spinup=10        # Change to fit initial SOC stock of model ---> 12 for PK+ME-FB
clay_Spinup=7        # Same as model
Cinputs_Spinup=2.17     # Change to historical land-use --> 2.17 (08.11.24)
...
write.csv2(FB_FYM_rows_C_Model, file = "output/farako_ba/treatments/FB_FYM_rows_C_model.csv")
write.csv2(FB_FYM_final_pools, file = "output/farako_ba/treatments/FB_FYM_final_pools.csv")
write.csv2(FB_FYM_total_C, file = "output/farako_ba/treatments/FB_FYM_total_C.csv")
```
