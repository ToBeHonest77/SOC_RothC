...
Cinputs_Spinup=1.95  # 1.95 for C-FB
...
write.csv2(FB_C_rows_C_Model, file = "output/farako_ba/treatments/FB_C_rows_C_model.csv")
write.csv2(FB_C_final_pools, file = "output/farako_ba/treatments/FB_C_final_pools.csv")
write.csv2(FB_C_total_C, file = "output/farako_ba/treatments/FB_C_total_C.csv")
```